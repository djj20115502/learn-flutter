...
// https://blog.csdn.net/XG1057415595/article/details/86761702
//InheritedWidget 就相当于能向下传递参数
...
class TestWidgetD extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class _InheritedWidgetTestContainerState
  ...
  @override
  Widget build(BuildContext context) {
    CommonUtils.log2(["InheritedWidgetTestContainer build" ]);
